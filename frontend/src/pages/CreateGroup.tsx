...
const WORD_BANK = {
  first: ["Snowy", "Cozy", "Twinkling", "Merry", "Frosty", "Jolly", "Ginger"],
  second: ["Pine", "Cocoa", "Starlit", "Caroling", "Candle", "Bells", "Ribbon"],
  third: ["Reindeer", "Mittens", "Starlight", "Peppermint", "Lantern", "Penguin", "Wonder"],
};
